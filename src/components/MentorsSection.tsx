    ...
    <section id="mentors" className="py-24 md:py-32 px-6 md:px-12 max-w-[1280px] mx-auto relative z-10">
      ...
      <div className="grid md:grid-cols-2 gap-6 reveal-content">
        <div className="glass-card relative overflow-hidden reveal-card flex flex-col md:flex-row" style={{ transitionDelay: '0ms' }}>
          ...
          <div className="relative z-10 p-8 md:p-12 md:w-[55%]">
          ...
          <div
            className="relative overflow-hidden md:w-[45%] min-h-[280px] md:min-h-0"
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(to right, rgba(14,14,15,0.9) 0%, rgba(14,14,15,0.3) 40%, transparent 100%)',
              }}
            />
            <div
            ...
            <div
              className="absolute bottom-4 left-4 z-10 font-label flex items-center gap-1.5"
              style={{ fontSize: '9px', color: '#D0FF00', letterSpacing: '0.2em' }}
            >
              ACTIVE
              <span
                className="inline-block w-1.5 h-1.5 rounded-full"
                style={{ background: '#D0FF00', animation: 'pulse 2s cubic-bezier(0.4,0,0.6,1) infinite' }}
              />
            </div>
          </div>
        </div>
