      ...
      <div className="grid md:grid-cols-2 gap-[1px] bg-border reveal-content">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-2">
              {['Forex', 'Indices', 'Crypto', 'SMC', 'Prop Trading'].map(tag => (
                <span key={tag} className="bg-secondary text-[#777777] font-label text-[10px] tracking-[1px] uppercase px-3 py-1">{tag}</span>
              ))}
            </div>
          </div>
        </div>
        <div className="bg-background p-8 md:p-12 relative overflow-hidden reveal-card" style={{ transitionDelay: '100ms' }}>
          ...
          <div className="relative z-10">
            ...
            <span className="bg-secondary text-[#777777] font-label text-[10px] tracking-[1px] uppercase px-3 py-1">{t('Coming soon', 'Čoskoro')}</span>
          </div>
        </div>
      </div>
    </section>
