...
const MentorsSection = () => {
  ...
  return (
    <section id="mentors" className="py-24 px-6 max-w-7xl mx-auto reveal">
      <p className="text-primary font-body text-[10px] tracking-[4px] uppercase mb-4">{t('Team', 'Tím')}</p>
      <h2 className="font-heading text-6xl md:text-7xl text-foreground mb-16">{t('OUR MENTORS.', 'NAŠI MENTORI.')}</h2>
      ...
      <div className="grid md:grid-cols-2 gap-[1px] bg-border">
        ...
        <div className="bg-background p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-primary font-body text-[10px] tracking-[4px] uppercase mb-2">{t('Founder · Head Mentor', 'Zakladateľ · Hlavný Mentor')}</p>
            ...
            <div className="flex flex-wrap gap-2">
              {['Forex', 'Indices', 'Crypto', 'SMC', 'Prop Trading'].map(tag => (
                <span key={tag} className="bg-secondary text-muted-foreground font-body text-[10px] tracking-[1px] uppercase px-3 py-1">{tag}</span>
              ))}
            </div>
          </div>
        </div>
        ...
        <div className="bg-background p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-primary font-body text-[10px] tracking-[4px] uppercase mb-2">{t('Senior Mentor', 'Senior Mentor')}</p>
            ...
            <span className="bg-secondary text-muted-foreground font-body text-[10px] tracking-[1px] uppercase px-3 py-1">{t('Coming soon', 'Čoskoro')}</span>
          </div>
        </div>
      </div>
    </section>
