...
const MissionSection = () => {
  ...
  return (
    <section id="mission" className="py-24 px-6 max-w-7xl mx-auto reveal">
      <p className="text-primary font-body text-[10px] tracking-[4px] uppercase mb-4">{t('Who we are', 'Kto sme')}</p>
      <h2 className="font-heading text-6xl md:text-7xl text-foreground mb-16">
